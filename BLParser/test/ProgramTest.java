...
public abstract class ProgramTest {
     ...
     */
    @Test
    public final void testParseValidProgram3() {
        /*
         * Setup
         */
        Program pRef = this.constructorRef();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorProgram4() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorProgram5() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorProgram6() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorProgram7() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorProgram8() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
