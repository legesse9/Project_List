...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
         ...
         */
        // Create a substring removing the overlapping characters
        String str1Temp = str1.substring(0, str1.length() - overlap);
        String strFinal = str1Temp.concat(str2);
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        for (String element : strSet) {
            if (!element.contains(str)) {
                //if strings in set does not contain given string, count increases by one
                count++;
            }
        }
        /*
         * if none of the elements in the set contain the given string add it to
         * the temporary set. Check given string contains any element in set, if
         * not add it to temporary set.
         */
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        while (!input.atEOS()) {
            ...
            // Receive text from text data and call previous method
