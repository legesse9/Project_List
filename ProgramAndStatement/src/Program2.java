...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        Map<String, Statement> contextTemp = this.newContext();
        contextTemp.transferFrom(this.context);
        this.context.transferFrom(c);
        c.transferFrom(contextTemp);
    }
    ...
    public final void swapBody(Statement b) {
        ...
        Statement bodyTemp = this.newBody();
        bodyTemp.transferFrom(this.body);
        this.body.transferFrom(b);
        b.transferFrom(bodyTemp);
    }
